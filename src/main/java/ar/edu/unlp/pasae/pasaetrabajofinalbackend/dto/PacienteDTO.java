...
public class PacienteDTO extends GenericDTOImpl {
	...
	public PacienteDTO(Long id, int dni, boolean obraSocial, String obraSocialNombre, Long numeroAfiliado,
			String nombre, String apellido, String domicilio, String numeroTelefono) {
		super();
		this.setId(id);
		this.setDni(dni);
		this.setObraSocial(obraSocial);
