...
/*		HashSet<Prescripcion> prescripcionesP1 = new HashSet<Prescripcion>();
		...
		IngresoPaciente i2 = new IngresoPaciente("motivo2", "enfermedad 2", "diagostico sintomático2", "diagnostico presuntivo 2");
...
//		this.getUserRepository().save(new User(5L, "marcosmat","iriarte.marcos@gmail.com", "ROLE_STUDENT"));
	...
	private void createHistoria() {
		...
		Seguimiento seg2 = new Seguimiento("Seguimiento 2 con estudio TAC a resolverse después de que el estudio del seguimiento 3 haya sido resuelto.",estudioTac ,null);
		...
		Seguimiento seg3 = new Seguimiento("Seguimiento 3 con 2 estudios (Rx y RMN) y una prescripción. La Rx se realiza antes del seguimiento 4 y la RMN "
				+ "continua pendiente de realización", estudioSeg3, prescSeg3);
		ec2.setInformeResultado("Rotura de la primer falange del pulgar y la tercera del dedo índice, fisura de rodilla");
		...
		Seguimiento seg4 = new Seguimiento("Seguimiento 4 con una prescripcion de morfina.", null, prescSeg4);
